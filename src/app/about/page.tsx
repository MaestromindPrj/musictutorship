...
export const metadata: Metadata = {
  ...
  description:
    "Learn about Vijay, a music producer and educator with over a decade of industry experience, offering custom courses and 1-on-1 mentorship.",
};
...
export default function AboutPage() {
  return (
    <main className="main-wrapper main-content bg-white">
      ...
      <section
        className="container section-padding anim"
        style={{ "--anim-delay": "0.1s" } as any}
      >
        <div className="about-grid">
          ...
          <div className="about-content">
            <h2 className="about-title">
              Hi, I'm <span className="mentor-name"><i>Vijay</i></span>
            </h2>

            <p className="mentor-role">Music Producer & Educator</p>
            <div className="about-desc">
              <p>
                With over a decade of experience in music production, mixing,
                sound design, and music theory, I've dedicated my career to
                helping aspiring musicians unlock their creative potential and
                achieve professional success.
              </p>
              <p>
                My journey spans working with renowned artists across various
                genres, producing tracks that have reached millions of
                listeners, and mentoring hundreds of students who have gone on
                to build successful music careers.
              </p>
              <p>
                I believe that music production is not just about technology -
                it's about storytelling, emotion, and connecting with your
                audience. Through personalized mentorship, I guide students on a
                transformative journey that goes beyond software.
              </p>
            </div>
            <Link
              href="/contact"
              className="btn-dark anim"
              style={{ "--anim-delay": "0.7s" } as any}
            >
      ...
      <section
        className="bg-zinc-50 section-padding anim"
        style={{ "--anim-delay": "0.3s" } as any}
      >
            ...
            <div className="advantage-card">
              ...
              <div className="advantage-card-body">
                ...
                <p className="advantage-card-desc">
                  Worked with top artists and produced chart-topping tracks.
                </p>
              </div>
            </div>
