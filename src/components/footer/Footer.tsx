        ...
        <div className="footer-grid">
          <div className="footer-col">
            ...
            <p className="footer-desc">
              Elevate your music production journey with personalized mentorship
              and comprehensive courses designed to unlock your creative
              potential.
            </p>
          </div>
